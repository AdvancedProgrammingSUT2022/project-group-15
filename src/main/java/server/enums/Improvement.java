...
public enum Improvement {
    ...
    MINE("mine", 1, 0, 1,
            new ArrayList<>(Arrays.asList(Terrain.DESERT, Terrain.PLAIN, Terrain.GRASSLAND, Terrain.TUNDRA, Terrain.SNOWLAND, Terrain.HILL))
            , new ArrayList<>(Arrays.asList(Feature.JUNGLE, Feature.DENSE_FOREST, Feature.SWAMP))),
    ...
    PLANTATION("plantation", 0, 0, 0,
            new ArrayList<>(Arrays.asList(Terrain.DESERT, Terrain.PLAIN, Terrain.GRASSLAND)),
            new ArrayList<>(Arrays.asList(Feature.JUNGLE, Feature.DENSE_FOREST, Feature.SWAMP, Feature.FLAT))),
    QUARRY("quarry", 0, 0, 0,
